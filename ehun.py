...
#cl = LINE()
cl = LINE("ELl9zBMRfLBl1PRN8s8d.bNThAn2m83UdWG0//5YwNq.52dYrTwzOWRuVqN0rWe8qf2cRRi5fkfQkUCEsC0Xdm4=")
#cl = LINE("Email","Password")
cl.log("Auth Token : " + str(cl.authToken))
channelToken = cl.getChannelResult()
cl.log("Channel Token : " + str(channelToken))
#ki = LINE()
ki = LINE("ELlm4csJWbLdFfcd6q67.pz5bRPOi6mtyO7pGcajbzW.NIsG1LlphNC6hrRQ4SoKZcSUwTK1jctGFuuwFU+RDpY=")
            ...
            if op.param3 in Bots:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        if op.param3 not in wait["blacklist"]:
                            cl.kickoutFromGroup(op.param1,[op.param2])
                            cl.inviteIntoGroup(op.param1,[kiMID,admin])
                            ki.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            if op.param3 not in bl["blacklist"]:
                                ki.kickoutFromGroup(op.param1,[op.param2])
                                ki.inviteIntoGroup(op.param1,[clMID,admin])
                                cl.acceptGroupInvitation(op.param1)
                        except:
                            pass
        ...
        if op.type == 19:
            if clMID in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    grp = ki.getGroup(op.param1)
                    grp.preventJoinByeTicket = False
                    ki.updateGroup(grp)
                ...
                if text.lower() == 'help':
                  ...
                  if msg._from in admin:
                    if wait["Bot"] == True:
                      ...
                      for target in targets:
                          try:
                              admin.append(target)
                              cl.sendMessage(to,"Berhasilmenambah admin")
                          except:
                              pass
                  ...
                  if msg._from in admin:
                    if wait["Bot"] == True:
                      ...
                      ki.sendMessage(to, "Succes Menghapus Chat")
